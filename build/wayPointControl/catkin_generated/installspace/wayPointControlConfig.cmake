...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'wayPointControl' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/savio/Documents/autonomous-ws/install/${idir}'.  Ask the maintainer 'savio <savio@todo.todo>' to fix it.")
    endif()
